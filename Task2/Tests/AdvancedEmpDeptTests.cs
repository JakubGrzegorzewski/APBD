...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Select(e=> e).Where(e => e.Mgr != null);
        //
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        var result = emps.Select(e => e).Where(e => e.Sal > 500);
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = emps.Select(e => e).Where(e => e.Comm > 400); 
        
        Assert.True(result.All(r => r.Comm > 400));
    }
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = from emp in emps join mgr in emps on emp.Mgr equals mgr.EmpNo select new {Employee = emp.EName, Manager = mgr.EName};
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = from emp in emps
                     let total = emp.Sal + (emp.Comm ?? 0)
                     select new {emp.EName, Total = total};
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = from emp in emps
                     ...
                     select new {emp.EName, dept.DName, sal.Grade};
